...
import { StatusDot, AddToPoolButton, KeyValueEditor, TeamEndpointPicker, SaveConfigModal } from './shared';
...
export function KServeTab({ onMetric, onScore: onScoreParent, pool, onAddToPool, onRemoveFromPool, broadcastInput = '', broadcastTrigger = 0 }: {
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    saveRecentQuery(question.trim());  // ← save here in form handler
    setLastPrompt(question);
