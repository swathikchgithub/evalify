...
import { StatusDot, AddToPoolButton, TabGuide, KeyValueEditor, PromptEditor, TeamEndpointPicker, SaveConfigModal } from './shared';
...
export function CustomEndpointTab({ onMetric, onScore: onScoreParent, pool, onAddToPool, onRemoveFromPool, broadcastInput = '', broadcastTrigger = 0 }: {
  ...
  return (
    <>
      <TabGuide id="custom-endpoint" title="How to use Custom Endpoint" steps={[
        { icon: '🔗', title: 'Enter URL', desc: 'Paste your OpenAI-compatible API URL e.g. https://your-server.com/v1', color: '#6366f1' },
        { icon: '🔑', title: 'Add API Key', desc: 'Enter your API key. Leave blank if not required.', color: '#f97316' },
        { icon: '🔒', title: 'Skip SSL', desc: 'Toggle on if your server uses self-signed certificates.', color: '#10b981' },
        { icon: '💬', title: 'Send Query', desc: 'Type a question and click Send. Save configs for reuse.', color: '#f59e0b' },
      ]} tip="Works with Ollama, vLLM, LM Studio, Together AI and more." />
